...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Professional Year ICT}{Jan. 2016 -- Dec. 2016}
    \resumeSubheading
      {Monash University}{Melbourne, Australia}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{}{Won Corporate and Industry Award by obtaining the highest GPA in the course.}
      \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        {Lectured for Semester 2, 2018. Introduced and utilised \textit{JPLAG} as a tool to detect code similarity for student
        assignments}   
        \resumeItem{FIT9134 - Computer Architecture \& Operating Systems}
        {}
        \resumeItem{FIT5032 - Internet Applications Development}
          {Contributed signficantly to the restructuring and enhancements of the unit. Previous offerings of the unit was based on ASP.NET Web Forms}   
        \resumeItem{FIT5120 - Industry Experience Project}
          {}
        \resumeItem{FIT5136 - Software Engineering}
          {}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Push Notifications - }
          {Created Push Notifications features using Firebase}
